...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "Pipeline Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("PipelineController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("PipelineController")
})
