...
// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the Pipeline resource tests

var _ = Describe("Pipeline", func() {
	var instance Pipeline
	var expected Pipeline
	var client PipelineInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ConcourseV5alpha1().Pipelines("default")
