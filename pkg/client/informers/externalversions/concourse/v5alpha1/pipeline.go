...
type PipelineInformer interface {
	...
	Lister() v5alpha1.PipelineLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ConcourseV5alpha1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConcourseV5alpha1().Pipelines(namespace).Watch(options)
			},
		},
		&concourse_v5alpha1.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&concourse_v5alpha1.Pipeline{}, f.defaultInformer)
}

func (f *pipelineInformer) Lister() v5alpha1.PipelineLister {
	return v5alpha1.NewPipelineLister(f.Informer().GetIndexer())
}
