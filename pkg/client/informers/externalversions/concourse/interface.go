...
type Interface interface {
	// V5alpha1 provides access to shared informers for resources in V5alpha1.
	V5alpha1() v5alpha1.Interface
}
...
// V5alpha1 returns a new v5alpha1.Interface.
func (g *group) V5alpha1() v5alpha1.Interface {
	return v5alpha1.New(g.factory, g.namespace, g.tweakListOptions)
}
