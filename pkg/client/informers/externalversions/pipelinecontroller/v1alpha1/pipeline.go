...
import (
	...
	pipelinecontroller_v1alpha1 "github.com/topherbullock/knative-build-pipeline-poc/pkg/apis/pipelinecontroller/v1alpha1"
	...
	v1alpha1 "github.com/topherbullock/knative-build-pipeline-poc/pkg/client/listers/pipelinecontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PipelinecontrollerV1alpha1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PipelinecontrollerV1alpha1().Pipelines(namespace).Watch(options)
			},
		},
		&pipelinecontroller_v1alpha1.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelinecontroller_v1alpha1.Pipeline{}, f.defaultInformer)
}
