...
type PipelineInterface interface {
	Create(*v5alpha1.Pipeline) (*v5alpha1.Pipeline, error)
	Update(*v5alpha1.Pipeline) (*v5alpha1.Pipeline, error)
	UpdateStatus(*v5alpha1.Pipeline) (*v5alpha1.Pipeline, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v5alpha1.Pipeline, error)
	List(opts v1.ListOptions) (*v5alpha1.PipelineList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v5alpha1.Pipeline, err error)
	PipelineExpansion
}
...
func newPipelines(c *ConcourseV5alpha1Client, namespace string) *pipelines {
	return &pipelines{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *pipelines) Get(name string, options v1.GetOptions) (result *v5alpha1.Pipeline, err error) {
	result = &v5alpha1.Pipeline{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
		Name(name).
...
func (c *pipelines) List(opts v1.ListOptions) (result *v5alpha1.PipelineList, err error) {
	result = &v5alpha1.PipelineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Create(pipeline *v5alpha1.Pipeline) (result *v5alpha1.Pipeline, err error) {
	result = &v5alpha1.Pipeline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Update(pipeline *v5alpha1.Pipeline) (result *v5alpha1.Pipeline, err error) {
	result = &v5alpha1.Pipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) UpdateStatus(pipeline *v5alpha1.Pipeline) (result *v5alpha1.Pipeline, err error) {
	result = &v5alpha1.Pipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pipelines").
...
func (c *pipelines) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v5alpha1.Pipeline, err error) {
	result = &v5alpha1.Pipeline{}
