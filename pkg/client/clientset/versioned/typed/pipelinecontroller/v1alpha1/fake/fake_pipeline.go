...
type FakePipelines struct {
	Fake *FakePipelinecontrollerV1alpha1
	ns   string
}

var pipelinesResource = schema.GroupVersionResource{Group: "pipelinecontroller.k8s.io", Version: "v1alpha1", Resource: "pipelines"}

var pipelinesKind = schema.GroupVersionKind{Group: "pipelinecontroller.k8s.io", Version: "v1alpha1", Kind: "Pipeline"}
