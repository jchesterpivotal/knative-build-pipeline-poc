...
import (
	...
	samplescheme "github.com/topherbullock/knative-build-pipeline-poc/pkg/client/clientset/versioned/scheme"
	informers "github.com/topherbullock/knative-build-pipeline-poc/pkg/client/informers/externalversions/pipelinecontroller/v1alpha1"
	listers "github.com/topherbullock/knative-build-pipeline-poc/pkg/client/listers/pipelinecontroller/v1alpha1"
)

const controllerAgentName = "pipeline-controller"

const (
	// SuccessSynced is used as part of the Event 'reason' when a Pipeline is synced
	...
	MessageResourceExists = "Resource %q already exists and is not managed by Pipeline"
	// MessageResourceSynced is the message used for an Event fired when a Pipeline
	// is synced successfully
	MessageResourceSynced = "Pipeline synced successfully"
)

// Controller is the controller implementation for Pipeline resources
...
func NewController(
	...
	pipelineInformer informers.PipelineInformer) *Controller {
...
func (c *Controller) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if ok := cache.WaitForCacheSync(stopCh, c.deploymentsSynced, c.pipelinesSynced); !ok {
